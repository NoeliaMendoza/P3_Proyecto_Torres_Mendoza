...
INSERT INTO espacios_academicos (codigo, nombre, id_tipo, edificio, piso, capacidad, estado, tiene_proyector, tiene_computadoras) VALUES
  ('AULA-A',    'Aula A',      v_tipo_aula, 'Edificio A', 'PB',  40, 'disponible', true,  false),
  ('AULA-A01',  'Aula A01',    v_tipo_aula, 'Edificio A', '1er', 40, 'disponible', true,  false),
  ('AULA-A02',  'Aula A02',    v_tipo_aula, 'Edificio A', '1er', 40, 'disponible', true,  false),
  ('AULA-A09',  'Aula A09',    v_tipo_aula, 'Edificio A', '2do', 40, 'disponible', true,  false),
  ('AULA-A10',  'Aula A10',    v_tipo_aula, 'Edificio A', '2do', 40, 'disponible', true,  false),
  ('AULA-A11',  'Aula A11',    v_tipo_aula, 'Edificio A', '2do', 40, 'disponible', true,  false),
  ('AULA-A12',  'Aula A12',    v_tipo_aula, 'Edificio A', '2do', 40, 'disponible', true,  false),
  ('AULA-A13',  'Aula A13',    v_tipo_aula, 'Edificio A', '2do', 40, 'disponible', true,  false),
  ('AULA-A14',  'Aula A14',    v_tipo_aula, 'Edificio A', '2do', 40, 'disponible', true,  false),
  ('LAB-DCCO01','Lab DCCO 01', v_tipo_lab,  'DCCO',      '1er', 30, 'disponible', true,  true),
  ('LAB-DCCO02','Lab DCCO 02', v_tipo_lab,  'DCCO',      '1er', 30, 'disponible', true,  true),
  ('LAB-DCCO03','Lab DCCO 03', v_tipo_lab,  'DCCO',      '1er', 30, 'disponible', true,  true),
  ('LAB-DCCO04','Lab DCCO 04', v_tipo_lab,  'DCCO',      '2do', 30, 'disponible', true,  true),
  ('LAB-DCCO05','Lab DCCO 05', v_tipo_lab,  'DCCO',      '2do', 30, 'disponible', true,  true),
  ('LAB-DCCO06','Lab DCCO 06', v_tipo_lab,  'DCCO',      '2do', 30, 'disponible', true,  true),
  ('LAB-DCCO2', 'Lab DCCO 2',  v_tipo_lab,  'DCCO',      '1er', 30, 'disponible', true,  true),
  ('LAB-QUIM',  'Lab Química', v_tipo_lab,  'Edificio A', 'PB',  25, 'disponible', false, false),
