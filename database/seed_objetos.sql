-- Seed: Objetos perdidos y encontrados
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM categorias_objetos) THEN RETURN; END IF;
  ...
  INSERT INTO objetos_perdidos (titulo, descripcion, id_categoria, tipo, estado, ubicacion, fecha_evento, informacion_contacto) VALUES
